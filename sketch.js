...
player = createSprite(displayWidth-1150, displayHeight-300, 50, 50);
 player.addImage(shooterImg)
   ...
   heart1.visible = false
    ...
    //criando grupos para os zumbis e as balas
...
if(gameState === "fight"){
  ...
  //vá para gameState "won" (ganhou) se a pontuação for 100
  if(score==100){
    gameState = "won"
    winning.play();
  }
...
//exibir a pontuação, vidas e balas restantes
textSize(20)
  fill("white")
...
//destrua o zumbi, jogador e balas e exibir uma mensagem no gameState "bala"
